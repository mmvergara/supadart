...
class Test_table {
  final BigInt bigintx;
  final BigInt bigserialx;
  final String? bitx;
  final String? bitvaryingx;
  final bool? booleanx;
  final String? boxx;
  final String? byteax;
  final String? characterx;
  final String? charactervaryingx;
  final String? cidrx;
  final String? circlex;
  final DateTime? datex;
  final double? doublex;
  final String? inetx;
  final int? integerx;
  final Duration? intervalx;
  final Map<String, dynamic>? jsonx;
  final Map<String, dynamic>? jsonbx;
  final String? linex;
  final String? lsegx;
  final String? macaddrx;
  final String? macaddr8x;
  final String? moneyx;
  final num? numericx;
  final String? pathx;
  final String? pg_lsnx;
  final String? pg_snapshotx;
  final String? pointx;
  final String? polygonx;
  final double? realx;
  final int? smallintx;
  final int smallserialx;
  final int serialx;
  final String? textx;
  final DateTime? timex;
  final DateTime? timetzx;
  final DateTime? timestampx;
  final DateTime? timestamptzx;
  final String? tsqueryx;
  final String? tsvectorx;
  final String? txid_snapshotx;
  final String? uuidx;
  final String? xmlx;
  final int? cleanup;
  final dynamic? text_arr;
  ...
  static String get c_text_arr => 'text_arr';
  static Map<String, dynamic> insert({
    BigInt? bigintx,
    BigInt? bigserialx,
    String? bitx,
    ...
    return {
      ...
      if (text_arr != null) 'text_arr': text_arr.toString(),
    };
  }
