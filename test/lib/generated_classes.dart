...
if (charactervaryingx != null) 'charactervaryingx': charactervaryingx.toString(),
...
if (timetzx != null) 'timetzx': DateFormat('HH:mm:ss zzzz').format(timetzx),
...
bitvaryingx: json['bitvaryingx'] != null ? json['bitvaryingx'] as String : null,
...
characterx: json['characterx'] != null ? json['characterx'] as String : null,
charactervaryingx: json['charactervaryingx'] != null ? json['charactervaryingx'] as String : null,
...
doublex: json['doublex'] != null ? double.tryParse(json['doublex'].toString()) : null,
inetx: json['inetx'] != null ? json['inetx'] as String : null,
integerx: json['integerx'] != null ? json['integerx'] as int : null,
intervalx: json['intervalx'] != null ? json['intervalx'] as Duration : null,
jsonx: json['jsonx'] != null ? json['jsonx'] as Map<String, dynamic> : null,
jsonbx: json['jsonbx'] != null ? json['jsonbx'] as Map<String, dynamic> : null,
...
timex: json['timex'] != null ? DateTime.tryParse("1970-01-01T${json['timex']}") : null,
timetzx: json['timetzx'] != null ? DateTime.tryParse("1970-01-01T${json['timetzx']}") : null,
timestampx: json['timestampx'] != null ? DateTime.tryParse(json['timestampx']) : null,
timestamptzx: json['timestamptzx'] != null ? DateTime.tryParse(json['timestamptzx']) : null,
tsqueryx: json['tsqueryx'] != null ? json['tsqueryx'] as String : null,
tsvectorx: json['tsvectorx'] != null ? json['tsvectorx'] as String : null,
txid_snapshotx: json['txid_snapshotx'] != null ? json['txid_snapshotx'] as String : null,
